...
public class SwaggerConfig {
    ...
    */
    ...
    private static final String SERVICE_NAME = "Trading Day";
    private static final String API_VERSION = "V1";
    private static final String API_DESCRIPTION = "Trading Day API TEST";
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title(SERVICE_NAME) // 서비스명
                ...
                .licenseUrl("https://github.com/swings134man/tradingDay")
                .build();
